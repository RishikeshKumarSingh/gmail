...
<body>
        ...
        <div class="container-fluid mt-4">
                <div class="row">
                        ...
                        <div class="col-9">
                                <h6 class="lead my-3 ms-5">All Mails</h6>
                                <table class="table">
                                        <?php 
                                        ...
                                        reciver_id='$loginedUserId' OR sender_id='$loginedUserId' ORDER BY mail_id DESC");
                                                ...
                                                <tr>
                                                        ...
                                                        <td>
                                                                <a href="viewMail.php?id=<?=$row['mail_id'];?>" class="text-decoration-none"> <strong>
                                                                        <?php
                                                                        if($row['status'] == 1 && $row['reciver_id'] == $loginedUserId){
                                                                               echo "<span class='badge bg-primary'>Inbox</span>";
                                                                        }
                                                                        elseif($row['status'] == 1 && $row['sender_id'] == $loginedUserId){
                                                                                echo "<span class='badge bg-warning'>Outbox</span>"; 
                                                                        }
                                                                        elseif($row['status'] == -1){
                                                                                echo "<span class='badge bg-danger'>Trash</span>";
                                                                        }
                                                                        elseif($row['status'] == 0){
        ...
        <?phpif(isset($_POST['send']) || isset($_POST['save'])){
                $to = $_POST['to']; 
        ...
        $status =1; //1=mail send(inbox) //0=draft // -1 =trash
        ...
        value ('$sender_id','$reciver_id','$subject','$content','$attach')");
